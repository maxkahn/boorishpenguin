...
//these are copied from the shortly-express sprint
  //what do we need to test on the server-side?
  //I. database connection
    //creating a new entry for each table
    //retrieving a new entry for each table
    //deleting an entry for each table
  //II. client connection
    //sending appropriate requests to each possible route
...
describe('', function() {
  ...
  beforeEach(function() {
    //TODO
    // log out currently signed in user (when we have functionality to do this)
